...
5. Collects the artifact(s) the role wrote, commits on the feature branch, destroys the
   sandbox. Fresh sandbox per step = the fresh-context rule, physically enforced.
