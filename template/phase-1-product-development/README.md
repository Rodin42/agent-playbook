...
| --- | --- | --- |
| [`project-brief.md`](project-brief.md) | Why the product exists, for whom, what "good" means, product-level non-goals. Written before anything else, in plain words. | PO or operator | **Operator** (revisit on direction change) |
